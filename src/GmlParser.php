...
final class GmlParser
{
    ...
    private static function parcel(DOMDocument $dom): ?array
    {
        ...
        return [
            ...
            'land_type' => Codelists::fromHref(self::href($xpath, 'landType', $root)),
            'land_use' => Codelists::fromHref(self::href($xpath, 'landUse', $root)),
            'land_type_symbol' => Codelists::fromHref(self::href($xpath, 'landTypeSymbol', $root)),
